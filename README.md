...
👉 [**Part 0: Environment Setup**](part0-environment-setup/README.md)
...
| Part | Description |
|------|-------------|
| [Part 0: Environment Setup](part0-environment-setup/README.md) | Install required tools and configure your development environment |
| [Part 1: Foundations](part1-foundations/README.md) | Document Driven Development and building an Art Gallery project |
| [Part 2: Getting Started with MCPs](part2-getting-started/README.md) | Build your first MCP server (DateTime) and explore existing MCP servers |
| [Part 3: Build Custom MCPs](part3-build-custom-mcps/README.md) | Build Task Tracker (PostgreSQL) and Image Generation (Gemini API) MCP servers |
| [Part 4: Wrap Up](part4-wrap-up/README.md) | Review and next steps |
